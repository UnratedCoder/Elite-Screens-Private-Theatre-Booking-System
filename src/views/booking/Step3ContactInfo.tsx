        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-300 bg-white py-3 pl-11 pr-4 text-sm text-[#111827] placeholder-gray-400 focus:border-[#C85A17] focus:outline-hidden"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative flex">
              ...
              <input
                ...
                className="w-full rounded-r-xl border border-gray-300 bg-white py-3 px-4 text-sm text-[#111827] placeholder-gray-400 focus:border-[#C85A17] focus:outline-hidden"
              />
            </div>
          </div>
        ...
        <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-[#f9fafb] p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-[9px] text-gray-500 font-medium">Max Capacity {activeTheater.maxCapacity} Adults</p>
            </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-[#f9fafb] p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-[9px] text-gray-500 font-medium">Charged separately at ₹200 per kid</p>
            </div>
            <div className="flex items-center gap-3">
              <button
                type="button"
            ...
            <div className="flex flex-wrap gap-2 justify-end">
              {theaterId === "theatre-1" && (
                <>
                  <button
                    type="button"
                    onClick={() => {
                      setTheaterId("theatre-2");
                      const nextSlotId = selectedTheaterSlots["theatre-2"];
                      if (nextSlotId) {
              ...
              {theaterId === "theatre-2" && (
                <button
                  type="button"
                  onClick={() => {
                    setTheaterId("theatre-3");
                    const nextSlotId = selectedTheaterSlots["theatre-3"];
                    if (nextSlotId) {
                      setSlotId(nextSlotId);
                    }
                  }}
