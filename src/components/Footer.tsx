    ...
    <footer className="border-t border-white/10 bg-[#0f1115] text-white px-6 pb-6 pt-12 md:px-8 md:pt-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-14 md:mb-16">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-flex items-center gap-2.5">
              <div className="bg-[#FFD700] rounded-full flex items-center justify-center p-1 w-12 h-12 shadow-[0_2px_10px_rgba(255,215,0,0.15)]">
                <div className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-[#FFD700] font-bold text-xs">
                  DS
                </div>
              </div>
              <span className="font-serif font-bold text-xl tracking-wide text-white">
                Dazzling<span className="text-[#FFD700]">Screens</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <a
                ...
                aria-label="Dazzling Screens on Instagram"
                className="text-white/80 transition hover:text-[#FFD700]"
                href="https://www.instagram.com/dazzlingscreens/"
              >
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Dazzling Screens on Facebook"
                className="text-white/80 transition hover:text-[#FFD700]"
                href="https://www.facebook.com/p/Dazzling-Screens-Private-Theater-Celebration-Space-61562420245027/"
              >
                <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Dazzling Screens on YouTube"
                className="text-white/80 transition hover:text-[#FFD700]"
                href="https://www.youtube.com/@dazzlingscreens"
              >
                <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
            ...
            <div className="space-y-2.5 text-sm text-white/80">
              <a href="tel:+919289289696" className="flex items-center gap-2.5 transition hover:text-[#FFD700]">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-phone text-[#FFD700]">
                  <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path>
                </svg>
                +91 92892 89696
              </a>
              <a href="mailto:hello@dazzlingscreens.com" className="flex items-center gap-2.5 transition hover:text-[#FFD700]">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-mail text-[#FFD700]">
                  <rect width="20" height="16" x="2" y="4" rx="2"></rect>
                  <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                </svg>
                hello@dazzlingscreens.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-xs text-white/50">
          <p>© 2026 Dazzling Screens LLP. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
