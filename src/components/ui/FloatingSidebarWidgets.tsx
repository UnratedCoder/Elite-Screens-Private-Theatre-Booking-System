...
export default function FloatingSidebarWidgets() {
  ...
  const widgets = [
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://wa.me/919853247324?text=Hi%20Elite%20Screens%20%0A%0AI%27m%20interested%20in%20booking%20a%20private%20theatre%20for%20a%20special%20occasion.%20Could%20you%20please%20guide%20me%20with%20availability%2C%20pricing%2C%20and%20options%3F%0A%0AThanks!",
          "_blank"
        );
      },
